...
Usage:
    python rc2sh.py "id"
    python rc2sh.py "pm install -r -g /sdcard/DjiParam.apk"
    python rc2sh.py --host 192.168.31.107 --port 2323 "getprop ro.build.display.id"
"""
import argparse
import re
import sys
...
def main():
    ...
    ap.add_argument("--host", default="192.168.31.107")
